...
Shader "VertexPainter/SplatBlendSpecular_5Layer" 
{
   Properties {
      ...
      _SpecColor5("Specular Color", Color) = (0.2, 0.2, 0.2, 0.2)
      [NoScaleOffset]_SpecGlossMap5("Specular/Gloss Map", 2D) = "black" {}
   ...
   SubShader {
      ...
      void surf (Input IN, inout SurfaceOutputStandardSpecular o) 
      {
         ...
         o.Specular = lerp(lerp(lerp(lerp(_SpecColor1, _SpecColor2, b1), _SpecColor3, b2), _SpecColor4, b3), _SpecColor5, b4).rgb;
         #endif
