...
©2015 Jason Booth
	...
	After copying the package into your Unity project, open the vertex painter via the “Tools->Vertex Painter” menu item. Next, select the objects you wish to paint in your scene and make sure the “Enabled” check box is checked. You can toggle this option with the ESC key when the window is active. 
